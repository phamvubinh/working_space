...
def cube(startPoint, fullSize):
    ...
    node_5 = [node_1[0]+offset, node_1[1]-y_offset]
    node_6 = [node_2[0]+offset, node_2[1]-y_offset]
    node_7 = [node_3[0]+offset, node_3[1]-y_offset]
    node_8 = [node_4[0]+offset, node_4[1]-y_offset]
