...
def fireShell(xy, tankX, tanky, turPos, gunPower, xLocation, barrierWidth, randomHeight, enemyTankX, enemyTankY):
    fire = True
    ...
    while fire:
        ...
        if startingShell[1] > display_height - ground_height:
            ...
            if enemyTankX + 15 >= hit_x and enemyTankX - 15 <= hit_x:
                print("HIT TARGET: ", hit_x, hit_y)
                damge = 25
...
def health_bars(player_health, enemy_health):
    ...
    pygame.draw.rect(gameDisplay, player_health_color, (680, 0, player_health, 25))
    pygame.draw.rect(gameDisplay, enemy_health_color, (680, 30, enemy_health, 25))
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                if event.key == pygame.K_LEFT:
                    ...
                    damage = fireShell(gun, mainTankX, mainTankY, currentTurPos, powerLevel, xLocation, barrierWidth, randomHeight, enemyTankX, enemyTankY)
                    enemy_health -= damage
                    print("mainTankX", mainTankX)
                    print("mainTankY", mainTankY)
                    damage = e_fireShell(enemy_gun, mainTankX, mainTankY, 7, 50, xLocation, barrierWidth, randomHeight, mainTankX, mainTankY)
