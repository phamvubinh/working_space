...
def fireShell(xy, tankX, tanky, turPos, gunPower, xLocation, barrierWidth, randomHeight, tank = "player"):
    fire = True
...
def e_fireShell(xy, tankX, tanky, turPos, gunPower, xLocation, barrierWidth, randomHeight, tank = "enemy"):
    fire = True
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                if event.key == pygame.K_LEFT:
                    ...
                    fireShell(gun, mainTankX, mainTankY, currentTurPos, powerLevel, xLocation, barrierWidth, randomHeight, tank = "player")
                    e_fireShell(enemy_gun, mainTankX, mainTankY, 8, 50, xLocation, barrierWidth, randomHeight, tank = "enemy")
