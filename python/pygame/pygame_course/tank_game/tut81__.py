...
def e_fireShell(xy, tankX, tanky, turPos, gunPower, xLocation, barrierWidth, randomHeight, pTankX, pTankY):
    ...
    while fire:
        ...
        # y = x**2
        gunPower = random.randrange(int(currentPower*0.9), int(currentPower*1.1))
        startingShell[1] += int((((startingShell[0]-xy[0])*0.015/(currentPower/50))**2) - (turPos+turPos/(12-turPos)))
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                if event.key == pygame.K_LEFT:
                    ...
                    print("damage", damage)
                    damage = e_fireShell(enemy_gun, enemyTankX, enemyTankY, 7, 50, xLocation, barrierWidth, randomHeight, mainTankX, mainTankY)
